...
static std::map<std::string, unsigned int> mapFlagNames = {
    ...
    {std::string("DISCOURAGE_CTVCSFSINTERNALKEY"), (unsigned int)SCRIPT_VERIFY_DISCOURAGE_CTVCSFSINTERNALKEY},
    {std::string("CTVCSFSINTERNALKEY"), (unsigned int)SCRIPT_VERIFY_CTVCSFSINTERNALKEY},
};
