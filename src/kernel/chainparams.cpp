...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].min_activation_height = 0; // No activation delay
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // Deployment of ctv/csfs/internalkey (BIPs 119, yyy, zzz)
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CTVCSFSINTERNALKEY].min_activation_height = 0;
